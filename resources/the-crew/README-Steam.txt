...
2) Click on the "+ button" (bottom left) to add a new installation, then select "TheCrew.exe" from the same folder
...
5) Exit TCULauncher, and launch "The Crew" from Steam like a normal game (you can also click on "Play on Steam", if you prefer).

6) Troubleshoot - if your antivirus goes crazy when you tries to launch the game, that's because TCULauncher uses DLL Injection to emulate the server.
